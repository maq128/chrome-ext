...
function() {
	var e, t = function() {},
		...
		n = o.length;
	0 == /mmdebug/.test(location.search) && location.href.indexOf("dev.web.weixin") < 0 && (window._console = window.console, window.console = {});
...
function() {
	...
	angular.module("Controllers").controller(
					"appController",
					["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "actionTrack", "surviveCheckService", "subscribeMsgService", "stateManageService",
					function(e, t, o, n, r, a, i, c/*mmpop*/, s, l, u, f, d, g, m, p, h, M, y, C, v, w) {
		function S() {
...
function() {
	...
	angular.module("Controllers").controller(
					...
					["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory",
...
_console.log('message:add:success: -- event --', t);
_console.log('message:add:success: -- msg --', o);
	...
	angular.module("Controllers").controller("createChatroomController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p) {
		...
		t.pickConfig = {
			...
			return angular.forEach(t.selectedUsers, function(e, o) {
				...
				e.BaseResponse && 0 == e.BaseResponse.Ret ? (n.go("chat", {
...
function() {
	...
	angular.module("Services").factory(
						"contactFactory",
						["$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp",
		...
		var d, g = window._contacts = {},
			...
			A = {
				...
				pickContacts: function(e, t, o) {
					...
					switch (n = e[l], a = t[n] || {}, a = $.extend({}, a, s), n) {
					case "star":
...
function() {
	...
	angular.module("Directives").directive("contactListDirective", ["$timeout", "confFactory", function() {
		return {
			...
			link: function(e) {
				console.log("allContact", e.allContacts), e.heightCalc = e.heightCalc ||
				function(e) {
...
angular.module("Directives").directive(
								"navChatDirective",
								["$timeout", "$log", "$document", "$stateParams", "$rootScope", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService",
...
angular.module("Directives").directive(
								"navReadDirective",
								["$timeout", "$log", "$document", "$stateParams", "$rootScope", "$state", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", "subscribeMsgService",
...
angular.module("Directives").directive(
								"contactPicker",
								["$timeout", "$log", "$document", "$stateParams", "$rootScope", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", "mmpop",
								function(e, t, o, n, r, a, i, c, s, l, u, f) {
	function d(e) {
